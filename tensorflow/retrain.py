...
def create_image_lists2(image_dir, testing_percentage, validation_percentage):
...
def main(_):
    ...
    image_lists = create_image_lists2(FLAGS.image_dir, FLAGS.testing_percentage,
...
if __name__ == '__main__':
    ...
    FLAGS.image_dir = '/mnt/sdb1/datasets/leaves/leaves1_splitted'
